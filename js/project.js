...
const rightList = [
    ...
    <br>
    <p>
    첫 번째 Front-End 프로젝트인 만큼, 부족하고 보완할 점이 많은 웹 페이지이지만 하면서 내가 무엇이 부족하고 무엇을 더 공부하고 싶다는
        목표가 세워져 의미있는 프로젝트가 되었습니다. 개인적으로 아쉬운 점은, Back-end와 협업을 하지 않고 Front-End 기술만 들어간
    프로젝트여서
